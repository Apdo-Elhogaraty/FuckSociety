...
class SavedCode:
    ...
    def SavedCode(self):
        # Scapy Code
        lbl = tk.Label(self.frame,text="Scapy Code",bg=MainVariables.markup_danger,fg="#fff",font=('Hack',15,'bold'),width=20)
        lbl.place(x=20,y=30)
        ...
        btn.place(x=45,y=70)
        btn = tk.Button(self.frame,text="ARP" ,bg='blue',font=('Hack',13,'bold'),width=17,bd=0)
