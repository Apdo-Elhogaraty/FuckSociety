...
from Frames import My_Dialy_Frame,Saved_Code_Frame
import sys
...
# --- main window background image ---
        img = Image.open(f"{MainVariables.project_path}/images/{random.randrange(1, 9, 1)}.jpg")
        ...
        # --- Frame List ---
        frameList = [homeFrame,diaryFrame,codeFrame]
